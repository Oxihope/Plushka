...
class CLI:
    ...
    @staticmethod
    def print_humans(human_list: List["Human"]) -> None:
        for i, human in enumerate(human_list):
            print(f"{i + 1}. {human.name}")

    @staticmethod
    def print_human_notification_list(human: "Human") -> None:
    ...
    @staticmethod
    def print_human_package_list(human: "Human") -> None:
    ...
    def get_human_operation_choose(self) -> str:
        ...
        while True:
            if not human_operation_choose:
                ...
                human: "Human" = self.storage.human_list[human_index]
    ...
    @staticmethod
    def take_package_operation(human: "Human", notification: "Notification") -> None:
    ...
    def take_package_menu(self, human: "Human") -> None:
        while True:
    ...
    @staticmethod
    def print_post_offices(post_office_list: List["PostOffice"]) -> None:
    ...
    @staticmethod
    def send_package_operation( human: "Human", package: "Package", human_taker: "Human", first_post_office: "PostOffice", second_post_office: "PostOffice") -> None:
    ...
    def second_post_office_menu(self, human: "Human", package: "Package", human_taker: "Human", first_post_office: "PostOffice") -> bool:
        while True:
    ...
    def first_post_office_menu(self, human: "Human", package: "Package", human_taker: "Human") -> bool:
        while True:
    ...
    def human_taker_menu(self, human: "Human", package: "Package") -> None:
        while True:
    ...
    def send_package_menu(self, human: "Human") -> None:
        while True:
            ...
            match package_choose:
                ...
                case n if n == len(human.package_list) + 1:
                    ...
                    new_package = Package(package_text)
    ...
    def human_operation_menu(self, human: "Human") -> None:
        while True:
    ...
    def get_post_office_operation_choose(self) -> str:
        ...
        post_office: "PostOffice" = self.storage.post_office_list[post_office_index]
        while True:
    ...
    def print_post_office_to_sent_package_list(post_office: "PostOffice") -> None:
    ...
    def print_post_office_received_package_list(post_office: "PostOffice") -> None:
    ...
    def post_office_operation_menu(self, post_office: "PostOffice") -> None:
        while True:
        ...
        while True:
            ...
            match post_office_choose:
                ...
                case n if n == len(self.storage.post_office_list) + 1:
                    ...
                    new_post_office = PostOffice(post_office_name,post_office_condition)
