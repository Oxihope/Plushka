...
class Storage:
    def __init__(self, human_list = [], post_office_list = [], case_dict = {}):
        self.human_list: List["Human"] = human_list
        self.post_office_list: List["PostOffice"] = post_office_list
    ...
    def load_all(self, filename: str = "data.json") -> None:
        ...
        human_list = [Human.from_dict(human) for human in data["human_list"]]
        post_office_list = [PostOffice.from_dict(post_office) for post_office in data["post_office_list"]]
